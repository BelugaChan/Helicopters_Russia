...
namespace Algo.Abstract
{
    ...
    {
        public virtual List<KeyValuePair<TStandart, double>> OrderStandarts<TStandart>(Dictionary<TStandart, double> bestStandart)
        {
        ...
        {
            var orderedStandarts = OrderStandarts(bestStandart);
